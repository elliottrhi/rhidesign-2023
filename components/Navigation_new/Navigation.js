				    ...
				    <div className={ isOpen ? "nav__menu-wrapper dark:bg-stone-900 bg-stone-200 nav-active" : "nav__menu-wrapper dark:bg-stone-900 bg-stone-300"} >
                        ...
                        <div className="nav__menu-bottom">
                            <div className="nav__menu-socials">
                                <a href="https://www.linkedin.com/in/rhi-elliott/" target="_blank" className="socials-link">
                                ...
                                <a href="https://codepen.io/rhidesign/" target="_blank" className="socials-link">
                                ...
                                <a href="https://github.com/elliottrhi" target="_blank" className="socials-link">
