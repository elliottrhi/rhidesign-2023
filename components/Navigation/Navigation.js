...
export const Navigation = ({ items }) => {
    ...
    return (
        <main>
            <nav>
                <a href="/" className="dark:text-stone-300 text-stone-950">
					    ...
					    <div className="nav__menu-inner">
                            <div className="nav__menu-links-wrapper">
                                <ul className="nav__menu-links">
                                    {(items || []).map((item) => (
                                        <li key={item.id}>
                                            <a href={item.destination} className="cursor-pointer link nav__menu-link font-secondary" onClick={() => setOpen(!isOpen)}>
                                                {item.label}
                                            </a>
                                        </li>
                                    ))}
